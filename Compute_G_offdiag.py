...
config_data = loadtxt("/home/jiangl2/multi_block/multi_block_AMD_CPU/multi_block_AMD_1200/Glue_block/config_block.txt",dtype="int")
if config_data[N_index1-1,N_index2+1] != 30:
    f_index1 = config_data[N_index1-1,N_index2+1]
    if f_index1 > 1:
        f_index2 = 5 - f_index1
    else:
        f_index2 = 1 - f_index1
...
flp = loadtxt('/home/jiangl2/multi_block/inputdata_AMD_multi_block/Floorplan_AMD_multiblock.txt')

#DX = flp[4][0] - flp[8][0]
#DY = flp[8][3] - flp[4][3]
file_name1 = "/home/jiangl2/multi_block/multi_block_AMD_CPU/Gmsh_blocks/gmsh_block_mesh/Block_" + str(N_index1)+"_intf_"+str(f_index1)+".txt"
interface1 = loadtxt(file_name1)
file_name2 = "/home/jiangl2/multi_block/multi_block_AMD_CPU/Gmsh_blocks/gmsh_block_mesh/Block_" + str(N_index2)+"_intf_"+str(f_index2)+".txt"
...
coor = mesh.coordinates()
v2d = vertex_to_dof_map(V)
filename3 = "/home/jiangl2/multi_block/multi_block_AMD_CPU/multi_block_AMD_1200/Building_block/buidling_blk_" +str(N_index2)+"/podmode_fenics.txt"
...
u = Function(V)
for n in range(0,N_mode):
    podmode_load_file_name = "/home/jiangl2/multi_block/multi_block_AMD_CPU/multi_block_AMD_1200/Building_block/buidling_blk_" + str(N_index1)+"/podmode/mode_" + str(n) + "h5"
...
for i in range (0,N_mode):
    ...
    for j in range (0,N_mode):
        if f_index1 == 1 or f_index1 ==3:
            G_BC_matrix[i][j] = assemble(dot(u_n,inner(grad(podmode[j]),n))*ds(f_index1))
            #G_BC_matrix[i][j] = assemble(-dot(u_n,inner(grad(podmode[j]),n))*ds(f_index1))
        else :
            G_BC_matrix[i][j] = assemble(dot(u_n,inner(grad(podmode[j]),n))*ds(f_index1))
...
header = '/home/jiangl2/multi_block/multi_block_AMD_CPU/multi_block_AMD_1200/Building_block/buidling_blk_' + str(N_index1)+'/G_matrix_offdiag' + '_' + str(N_index1) +'_'+str(N_index2)
...
##############save the G_matrix_BC_diag
header = '/home/jiangl2/multi_block/multi_block_AMD_CPU/multi_block_AMD_1200/Building_block/buidling_blk_' + str(N_index1)+'/G_matrix_offdiag_penalty'+'_' + str(N_index1) +'_'+str(N_index2)
