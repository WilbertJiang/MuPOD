...
config_data = loadtxt("/home/jiangl2/multi_block_AMD_1200/Glue_block/config_block.txt",dtype="int")
if config_data[N_index1-1,N_index2+1] != 30:
    ...
    exit()
flp = loadtxt('/home/jiangl2/multi_block_AMD_1200/Floorplan_AMD_multiblock.txt')

#DX = flp[4][0] - flp[8][0]
#DY = flp[8][3] - flp[4][3]
file_name1 = "/home/jiangl2/multi_block_AMD_1200/gmsh_mesh/Block_" + str(N_index1)+"_intf_"+str(f_index1)+".txt"
interface1 = loadtxt(file_name1)
file_name2 = "/home/jiangl2/multi_block_AMD_1200/gmsh_mesh/Block_" + str(N_index2)+"_intf_"+str(f_index2)+".txt"
...
for i in range (0,N_mode):
    ...
    for j in range (0,N_mode):
        ...
        #print(assemble(u_n*ds(f_index1)))
